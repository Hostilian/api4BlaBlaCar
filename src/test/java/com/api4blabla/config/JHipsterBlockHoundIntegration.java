...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.api4blabla.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.api4blabla.security.DomainUserDetailsService", "createSpringSecurityUser");
